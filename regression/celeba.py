...
def main():
    ...
    parser.add_argument('--max_num_train_target_points', type=int, default=400)
    parser.add_argument('--resolution', type=int, default=32)

    # Model
    parser.add_argument('--model', type=str, default="cmanp")
    ...
    parser.add_argument('--num_latents_per_layer', type=int, default=128)
    ...
    # CMANP-AND Arguments
    parser.add_argument('--AND_block_size', type=int, default=None)
    parser.add_argument('--CMAB_block_size', type=int, default=None)
